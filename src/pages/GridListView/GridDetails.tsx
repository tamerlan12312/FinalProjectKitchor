...
/>
  ...
  <div className="d-flex justify-content-center align-o">
    ...
    <div className="blogTextFirst mt-5"><h1><a href="#react" className='animate__animated animate__fadeIn'>{ctx.lang.blog.blogtxt}</a></h1></div>
  </div>
</section>
   </div>
...
<div className="d-flex ms-1">
  ...
  <div className="row">
   ...
   <hr className="hr" />
   <h3 className="listTexth3 my-4">3 {ctx.lang.blog.comments}a</h3>
<div className="row">
